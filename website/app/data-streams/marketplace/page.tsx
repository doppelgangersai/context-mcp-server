                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                  ...
                  {nft.price ? (
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-primary text-white font-semibold hover:opacity-90 transition-opacity"
                    >
                    ...
                    <button
                      onClick={handleAction}
                      className="flex items-center gap-2 px-4 py-2 rounded-lg border border-white/20 text-white font-semibold hover:bg-white/5 transition-colors"
                    >
